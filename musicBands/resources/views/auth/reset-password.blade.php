...
@section('content')
  <h4>Olá, aqui podes fazer reset</h4>
       <form method="POST" action="{{ route('password.update') }}">
        @csrf
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Email address</label>
            <input value="{{ request()->email }}" name="email" required type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        ...
        <p>esqueceu-se a sua pass? Clique <a href="{{ route('password.request') }}">aqui</a> </p>
    </form>
